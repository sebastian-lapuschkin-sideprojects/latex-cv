...
Sebastian loves automation, PC gaming and woodland hiking (not simultaneously).
...
{\textsc{Berlin, Germany}}
{
    ...
    {Jan '19 -- present}
    {
        \bodytext{
            ...
            \emph{Research:}
            Developing \href{https://scholar.google.com/citations?view_op=view_citation&citation_for_view=wpLQuroAAAAJ:5nxA0vEk-isC}{Spectral Relevance Analysis}
            ...
            local XAI.
            Bringing modified backprop XAI to Keras/Tensorflow via
            \href{https://github.com/albermax/innvestigate}{iNNvestigate}.

            \vstep
            \emph{Other contributions:}
            Project (funding) acquisition.
            Recruiting and guiding of PhD students and student research assistants.
        }
    }
    ...
    {Oct '14 -- Dec '18}
    {
        \bodytext{
            ...
            Planning an conceptualization of a HPC cluster with modern GPU hardware implemented at Fraunhofer HHI.
...
{\textsc{Berlin, Germany}}
{
    ...
    {2013 -- 2018}
    {
        \bodytext{
            ...
            Spectral Relevance Analysis, \dots
...
{Technical:}
{
    ...
    Python (NumPy, PyTorch, Tensorflow), Matlab, Linux, bash, git, subversion, Slurm, Sun Grid Engine, \dots
...
{
    %\bodytext{
        Development and application and evaluation of, e.g.,\\
...
\inlineheadsection{DAKI-FWS (2021-12 - 2024-011)}{\href{https://www.hhi.fraunhofer.de/en/departments/ai/projects/daki-fws.html}{Data- and AI-supported Early Warning System}}
...
\inlineheadsection{TraMeExCo (2018-09 - 2021-08)}{\href{https://www.hhi.fraunhofer.de/en/departments/vca/projects/trameexco.html}{Transparent Medical Expert Companion}}
...
{Preprints}{}
{
    \begin{enumerate}
        ...
        \item \preprintref{Rieckmann A, Dworzynski P, Arras L, \textbf{Lapuschkin S}, Samek W, Onyebuchi A A, Rod N H, Ekstrom C T}
                            {2020}
