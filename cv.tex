...
% For the standalone publications.pdf build, \publicationsextra is defined:
% skip the header and every non-publication section, emitting ONLY the
% publications section. Otherwise (full cv / cv-short) render everything.
\ifdefined\publicationsextra\else
...
\fi % end \publicationsextra-else (front matter is omitted in the publications-only build)
