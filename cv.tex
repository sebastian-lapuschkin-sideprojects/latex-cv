...
\href{https://github.com/sebastian-lapuschkin}{github.com/sebastian-lapuschkin}\\ %
...
His research interests include computer vision, machine learning and data analysis,
data and algorithm visualization, and the interpretation and (meta-)analysis of machine learning system behavior.
...
{\textsc{Berlin, Germany}}
{
    ...
    {Sep '13 -- Sep '14}
    {
        \bodytext{
            ...
            Supervision by by Prof. Dr. Klaus-Robert M\"uller and Prof. Dr. Alexander Binder.
...
{\textsc{Berlin, Germany}}
{
    ...
    {2013 -- 2018}
    {
        \bodytext{
            ...
            \href{https://scholar.google.de/citations?user=wpLQuroAAAAJ&hl=de&oi=ao}{over 1200 citations according to Google Scholar}.
    ...
    \headedsubsection % Job title entry for the current employer
    {Master of Science degree in Computer Science \textnormal{(1.4 / ``very good'' / GPA 3.7)} }
    {2010 -- 2013}
    {
        \bodytext{
    ...
    \headedsubsection % Job title entry for the current employer
    {Bachelor of Science degree in Computer Science \textnormal{(2.0 / ``good'' / GPA 3.0)}}
    {2007 -- 2010}
    {
        \bodytext{
...
{
    \begin{enumerate}
        \item[] \preprintref{H\"agele M, Seegerer P, \textbf{Lapuschkin S}, Bockmayr M, Samek W, Klauschen F, M\"uller K-R, Binder A}
                            {2019}
