...
{\bf Contributions to Conference Proceedings and Workshops}{}
{
    \begin{enumerate}
        ...
        \item \conferenceref{Krakowczyk D G, Prasse P, Reich D R, \textbf{Lapuschkin S}, Scheffer T, Jäger L A}
                            {2023}
                            {Bridging the Gap: Gaze Events as Interpretable Concepts to Explain Deep Neural Sequence Models (ETRA)}
