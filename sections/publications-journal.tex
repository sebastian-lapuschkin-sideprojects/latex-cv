...
\begin{enumerate}
    ...
    \item \journalrefwnote{Becker S, Vielhaben J M, Ackermann M, Müller K-R, \textbf{Lapuschkin S} and Samek W}
                        {2023}
                        {AudioMNIST: Exploring Explainable Artificial Intelligence for Audio Analysis on a Simple Benchmark}
                        {Journal of the Franklin Institute}
                        {Pre-Proof}
                        {https://www.sciencedirect.com/science/article/pii/S0016003223007378}
                        {(\href{https://arxiv.org/abs/1807.03418}{Preprint})\\
