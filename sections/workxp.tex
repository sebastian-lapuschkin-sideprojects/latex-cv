...
{\textsc{Berlin, Germany}}
{
    ...
    {Jan '21 -- today}
    {
        \bodytext{
            ...
            {\small(current number of staff: 2 PostDocs, 17 PhD researchers \& 15 student research assistants).}
            ...
            \else
                ...
                (\href{https://conferences.miccai.org/2023/papers/544-Paper2359.html}{see also}).
