...
\begin{enumerate}
    ...
    \item \talkrefwnote{\textbf{Sebastian Lapuschkin}}
                    {2025-08-14}
                    {Explainability in the Era of LLMs: New Challenges and Pathways to Actionable Insights}
                    {2025 Workshop on Self-Supervised Learning for Signal Decoding, Aalborg, Denmark}
                    {invited talk}
