...
\headedsubsection{Determining a Solution of a Partial Differential Equation}{2025}
{
    \ifdefined\shortcv
        {}
    \else
        {
            \begin{enumerate}
                \item [] \patentpubref{TBA}
                                        {}
                                        {Determining a Solution of a Partial Differential Equation}
                                        {}
                                        {2025-11-03}
            \end{enumerate}
        }
    ...
    \else
        {
            \begin{enumerate}
                \item [] \patentpubref{TBA}
                                        {}
                                        {Output Token Selection in Machine Learning Models}
                                        {}
                                        {2025-09-25}
            \end{enumerate}
        }
